...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationStatement">
      <sch:assert test="count(f:extension[@url = 'https://apis.healthlink.go.th/api/v1/fhir/StructureDefinition/MedicationQuantity']) &gt;= 1">extension with URL = 'https://apis.healthlink.go.th/api/v1/fhir/StructureDefinition/MedicationQuantity': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://apis.healthlink.go.th/api/v1/fhir/StructureDefinition/MedicationQuantity']) &lt;= 1">extension with URL = 'https://apis.healthlink.go.th/api/v1/fhir/StructureDefinition/MedicationQuantity': maximum cardinality of 'extension' is 1</sch:assert>
